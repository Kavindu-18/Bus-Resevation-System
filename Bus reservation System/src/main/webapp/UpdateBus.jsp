        ...
        <aside>
            <div class="top">
                <div class="logo">
                    ...
                    <h2 id="k">Bus<span class="danger"></span>Picco</h2>
                </div>
            </div>
            <div class="sidebar" >
...
<div style="width: 70%; margin: auto;">
    <form action="Update-Bus" method="POST" style="display: flex; flex-direction: column; align-items: center; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px; background-color: #f9f9f9;">
        <div style="width: 100%;">
            <label for="regNo" style="font-weight: bold; margin-bottom: 10px;">Bus Registration No:</label>
            <input type="text" id="regNo" name="regNo" value ="<%= regNo %>" readonly  style="width: 100%; padding: 10px; border-radius: 5px; border: 1px solid #ddd; margin-bottom: 20px;">
        </div>
        <div style="width: 100%;">
            <label for="type" style="font-weight: bold; margin-bottom: 10px;">Bus Type:</label>
            <select id="type" name="type" value ="<%= type %>" style="width: 100%; padding: 10px; border-radius: 5px; border: 1px solid #ddd; margin-bottom: 20px;">
        ...
        <div style="width: 100%;">
            ...
            <input type="text" id="name" name="name" value ="<%= name %>" style="width: 100%; padding: 10px; border-radius: 5px; border: 1px solid #ddd; margin-bottom: 20px;">
        </div>
        
        <div style="width: 100%;">
            <label for="capacity" style="font-weight: bold; margin-bottom: 10px;">Seat Capacity:</label>
            <input type="number" id="capacity" name="capacity" value ="<%= capacity %>" style="width: 100%; padding: 10px; border-radius: 5px; border: 1px solid #ddd; margin-bottom: 20px;">
        </div>
        <div style="width: 100%;">
            <label for="route" style="font-weight: bold; margin-bottom: 10px;">Bus Route:</label>
            <input type="text" id="route" name="route" value ="<%= route %>" style="width: 100%; padding: 10px; border-radius: 5px; border: 1px solid #ddd; margin-bottom: 20px;">
        </div>
        <div style="width: 100%;">
            <label for="permitno" style="font-weight: bold; margin-bottom: 10px;">Permit Number:</label>
            <input type="text" id="permitno" name="permitNo" value ="<%= permitNo %>" style="width: 100%; padding: 10px; border-radius: 5px; border: 1px solid #ddd; margin-bottom: 20px;">
        </div>
